...
<!--		<!-- Banner -->
			<section id="banner">
				<div class="inner split">
					<section>
					<div align="left"><h2>Students Off Campus</a></h2>
					</div>
					</section>
					<section>
					<div align="right">
...
$sql = "SELECT * FROM InOutDetails WHERE InDate='0000-00-00' AND InTime='00:00:00';";
$result = $conn->query($sql);
//echo "<h1>Students Off Campus</h1>";
if($result->num_rows>=1){
 ...
 echo "</table>";
	...
	echo "<center><b>Everyone on campus!</b></center>";
}
